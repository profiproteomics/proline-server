...
object ExportConfigConstant {
  ...
  val FIELD_STAT_NB_PROTEIN_SETS_SINGLE_SPECIFIC_PEPTIDE = "stat_nb_protein_sets_single_specific_peptide"
  ...
  val FIELD_STAT_NB_PROTEIN_SETS_MULTI_SPECIFIC_PEPTIDE = "stat_nb_protein_sets_multi_specific_peptide"
  val FIELD_STAT_NB_Z2_PRECURSORS = "stat_nb_z2_precursors"
  val FIELD_STAT_NB_PEPTIDES = "stat_nb_peptides"
  val FIELD_STAT_NB_DISTINCT_SEQ = "stat_nb_distinct_seq"
