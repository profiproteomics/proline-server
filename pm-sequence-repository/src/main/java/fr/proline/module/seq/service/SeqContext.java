...
public class SeqContext {
    ...
    public SeqContext(final EntityManager seqEM, final SEDbInstance seDbInstance,
	    final Map<String, List<SEDbIdentifier>> existingSEDbIdents,
	    final Map<String, BioSequence> existingBioSequences, final Repository repository,
