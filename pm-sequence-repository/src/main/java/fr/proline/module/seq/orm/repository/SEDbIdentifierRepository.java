...
public final class SEDbIdentifierRepository {
	...
	public static List<SEDbIdentifier> findSEDbIdentByValues(final EntityManager seqEM, final Collection<String> values) {
		...
		return JPARepositoryUtils.executeInQueryAsBatch(seqEM.createNamedQuery("findSEDbIdentByValues", SEDbIdentifier.class), "values", values);
	}

	public static List<SEDbIdentifier> findSEDbIdentBySEDbInstanceAndValues(
		...
		final TypedQuery<SEDbIdentifier> query = seqEM.createNamedQuery("findSEDbIdentBySEDbInstanceAndValues", SEDbIdentifier.class);
		query.setParameter("seDbInstance", seDbInstance);

		return JPARepositoryUtils.executeInQueryAsBatch(query, "values", values);
	}

	public static List<SEDbIdentifier> findSEDbIdentBySEDbNameAndValues(
		final EntityManager seqEM,
		...
		final TypedQuery<SEDbIdentifier> query = seqEM.createNamedQuery("findSEDbIdentBySEDbNameAndValues", SEDbIdentifier.class);
