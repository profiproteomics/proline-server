...
java -Xmx4G -XX:+UseG1GC -XX:+UseStringDeduplication -XX:MinHeapFreeRatio=10 -XX:MaxHeapFreeRatio=30 -cp "config;pm-sequence-repository-${project.version}.jar;lib\*" fr.proline.module.seq.jms.RunNode
