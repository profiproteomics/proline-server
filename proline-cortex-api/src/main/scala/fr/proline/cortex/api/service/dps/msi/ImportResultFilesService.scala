...
case class ResultFileDescriptorsDecoyRegExp (
  ...
  @FieldDescription(content = "The Regular expression used to detect decoy protein matches.")
  decoyStrategy: Option[String] = None,
  
  // peaklistId parameter
  @FieldDescription(
    content = "The id of the peaklist that should correspond to this result file."
  )
...
case class ResultFileDescriptorRuleId(
  ...
  @FieldDescription(
    content = "The id of the peaklist that should correspond to this result file."
  )@JsonDeserialize(contentAs = classOf[java.lang.Long]) peaklistId: Option[Long] = None,

  // protMatchDecoyRuleId parameter
  @FieldDescription(
    content = "The id of the rule to be used to detect decoy protein matches."
  )
  @JsonDeserialize(contentAs = classOf[java.lang.Long])
...
trait IImportResultFilesService extends IImportResultFilesServiceParams with IMsiService {
  ...
  case class ImportedResultFile(
    @FieldDescription(
      content = "The path of the imported file."
    )
    path: String,
    
    @FieldDescription(
      content = "ID of created target result set."
    )
